...
export const ALL_COUNTRIES: Country[] = [
  ...
  { code: "US", name: "USA/Canada", dialCode: "+1", flag: "🇺🇸" },
  ...
  { code: "KZ", name: "Kazakhstan", dialCode: "+7", flag: "🇰ℤ" },
...
export function getCountryLabel(c: Country): string {
  return `${c.code} ${c.dialCode} (${c.name})`;
}
