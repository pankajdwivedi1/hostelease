...
export default function TenantSettingsView({ onRenew, generateInvoicePDF }: TenantSettingsViewProps = {}) {
                ...
                <div className="space-y-4 sm:space-y-6">
                    ...
                    <div className="bg-transparent sm:bg-indigo-50 sm:border sm:border-indigo-100 p-0 sm:p-6 sm:rounded-3xl space-y-3 sm:space-y-4">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5 sm:gap-4">
                        <div className="bg-white py-1.5 px-2.5 sm:p-5 rounded-xl sm:rounded-2xl shadow-sm border border-slate-100 sm:border-indigo-100/50 flex flex-col justify-center">
                          <p className="text-[7.5px] sm:text-[10px] text-gray-500 font-bold uppercase tracking-widest leading-none mb-1">Status</p>
                          <div className="flex items-center gap-1.5 sm:gap-2">
                            ...
                            <p className="text-[10.5px] sm:text-sm font-black text-gray-900 uppercase leading-none">
                        ...
                        <div className="bg-white py-1.5 px-2.5 sm:p-5 rounded-xl sm:rounded-2xl shadow-sm border border-slate-100 sm:border-indigo-100/50 flex flex-col justify-center">
                          <p className="text-[7.5px] sm:text-[10px] text-gray-500 font-bold uppercase tracking-widest leading-none mb-1">Time Remaining</p>
                          <p className="text-[10.5px] sm:text-sm font-black text-gray-900 leading-none">
                            {daysRemaining !== null 
                              ? `${daysRemaining} Days` 
                              : "N/A"}
                          </p>
                        ...
                        <div className="bg-white py-1.5 px-2.5 sm:p-5 rounded-xl sm:rounded-2xl shadow-sm border border-slate-100 sm:border-indigo-100/50 flex flex-col justify-center">
                          <p className="text-[7.5px] sm:text-[10px] text-gray-500 font-bold uppercase tracking-widest leading-none mb-1">Activation Date</p>
                          <p className="text-[10.5px] sm:text-sm font-bold text-gray-900 leading-none">
                            {settings.subscriptionStartDate ? new Date(settings.subscriptionStartDate).toLocaleDateString("en-IN", { dateStyle: "medium" }) : "N/A"}
                          </p>
                        </div>

                        <div className="bg-white py-1.5 px-2.5 sm:p-5 rounded-xl sm:rounded-2xl shadow-sm border border-slate-100 sm:border-indigo-100/50 flex flex-col justify-center">
                          <p className="text-[7.5px] sm:text-[10px] text-gray-500 font-bold uppercase tracking-widest leading-none mb-1">Expiry Date</p>
                          <p className="text-[10.5px] sm:text-sm font-bold text-gray-900 leading-none">
                      ...
                      <button
                        ...
                        className="w-full mt-2.5 sm:mt-4 py-2.5 sm:py-4 px-3 sm:px-6 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-black text-[10px] sm:text-sm uppercase tracking-wider sm:tracking-widest rounded-xl sm:rounded-2xl shadow-md sm:shadow-lg shadow-blue-500/20 transition-all flex items-center justify-center gap-1.5 active:scale-98 cursor-pointer"
                      >
                      ...
                      <div className="mt-3 sm:mt-6 bg-white p-3 sm:p-5 rounded-xl sm:rounded-2xl shadow-sm border border-slate-100 sm:border-indigo-100/50 relative overflow-hidden">
