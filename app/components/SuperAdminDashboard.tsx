...
export default function SuperAdminDashboard() {
    ...
    const generateSuperAdminInvoicePDF = (log: any, collegeName: string) => {
        ...
        const clientAddress = "Oriental Campus, Opp Patel Nagar, Raisen Road, Bhopal (M.P.) 462022";
        const clientEmail = "oistbpl@oriental.ac.in, admission@oriental.ac.in";
        const clientPhone = "Fax: 91 755 2529472, WhatsApp: +91 9993099997";
        
        const operatorName = targetTenant?.contactName || "Dr Pankaj Dwivedi";
        const operatorMobile = targetTenant?.contactPhone || "7974704918";
