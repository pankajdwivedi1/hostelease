                        ...
                        <>
                            ...
                            {!isParentView && (
                                <div className="space-y-2.5 sm:space-y-3 mb-3 sm:mb-6">
                                    ...
                                    {/* ⚡ Row 2: Full-Width Campus WiFi Network Banner (Zero Text Truncation) */}
                                    <div className={`w-full rounded-xl border-2 transition-all duration-500 flex items-center justify-between px-3 sm:px-4 py-2 text-left shadow-sm ${
                                        highlightLocation
                                            ? 'bg-amber-100 border-amber-400 ring-4 ring-amber-300 shadow-xl scale-[1.01] animate-pulse'
                                            : isOnCampusWifi
                                        ...
                                        {/* Left Side: Icon + Title + Full Guidance Text */}
                                        <div className="flex items-center gap-2.5 sm:gap-3 min-w-0 pr-2">
                                            <div className={`w-8 h-8 sm:w-9 sm:h-9 shrink-0 rounded-xl flex items-center justify-center text-sm sm:text-base ${
                                                isOnCampusWifi ? 'bg-emerald-200/80 text-emerald-800' : 'bg-amber-200/80 text-amber-800'
                                            }`}>
                                                📶
                                            </div>
                                            <div className="flex flex-col min-w-0">
                                                <span className={`block text-[8px] sm:text-[9px] font-black uppercase tracking-widest leading-none mb-1 ${
                                                    isOnCampusWifi ? 'text-emerald-800' : 'text-amber-800'
                                                }`}>
                                                    Campus WiFi Network
                                                </span>
                                                <p className={`text-[9px] sm:text-xs font-bold leading-tight ${
                                                    isOnCampusWifi ? 'text-emerald-950' : 'text-amber-950'
                                                }`}>
                                                    {isOnCampusWifi
                                                        ? 'Connected to hostel WiFi network for automated location verification.'
                                                        : 'Connect to your hostel WiFi network for smooth attendance without GPS location errors.'
                                                    }
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="shrink-0 flex flex-col items-end justify-center pl-2 sm:pl-3 border-l border-amber-200/80">
                                            <div className="flex items-center gap-1.5">
                                                ...
                                                <span className={`text-[8.5px] sm:text-[10px] font-black uppercase tracking-wider px-2 py-0.5 rounded-md ${
                                                    isOnCampusWifi
                                            ...
                                            <span className={`text-[7.5px] sm:text-[8.5px] font-black uppercase tracking-tight mt-1 ${
                                    ...
                                    {bankSettings?.isPaymentEnabled && (
                                        <button
                                            ...
                                            className="w-full h-12 rounded-xl bg-gradient-to-r from-blue-50 via-indigo-50 to-blue-100 border-2 border-blue-200 text-blue-950 font-black text-[9.5px] md:text-[11px] uppercase tracking-widest hover:border-blue-400 transition-all flex items-center justify-center gap-1.5 text-center leading-tight"
                                        >
