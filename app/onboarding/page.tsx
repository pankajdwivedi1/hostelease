    ...
    try {
      ...
      const response = await fetch("/api/students", {
        ...
        body: JSON.stringify({
          ...
          fatherName: formData.fatherName || (formData as any).fathersName || (formData as any).father_name || "",
          fatherNumber: formData.fatherNumber || (formData as any).fatherPhone || (formData as any).fathersPhoneNo || (formData as any).father_number || "",
          motherName: formData.motherName || (formData as any).mothersName || (formData as any).mother_name || "",
          motherNumber: formData.motherNumber || (formData as any).motherPhone || (formData as any).mothersPhoneNo || (formData as any).mother_number || "",
