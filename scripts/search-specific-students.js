...
async function run() {
  console.log("=== SEARCHING DESKTOP FILES FOR AAKANSHA, AARADHNA, AARUSHI ===");
  const names = ["AAKANSHA", "AARADHNA", "AARUSHI"];
  const dirs = [
  ...
  for (const file of files) {
    if (file.includes('inspect') || file.includes('smart-match') || file.includes('search-')) continue;
    try {
